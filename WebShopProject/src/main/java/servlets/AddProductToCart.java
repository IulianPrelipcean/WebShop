...
public class AddProductToCart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        File file = new File("/opt/tomcat/webapps/db_files/cart.xml");
        FileWriter file_logs = new FileWriter("/opt/tomcat/webapps/db_files/logs.txt", true);
        ...
        file_logs.close();
        response.sendRedirect("http://localhost:8090/WebShopProject/home");
    }
